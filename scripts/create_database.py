...
if __name__ == "__main__":
    ...
    out_filename = out_path + os.sep + "database_merengue_raw25.npz"
    skeleton_type = "raw"
    ...
    parser.add_argument('--src_fps', type=int,  default=50)
    parser.add_argument('--remove_broken_frames', "-f", default=True, dest='remove_broken_frames', action='store_true')
    parser.add_argument('--debug_plot', "-d", default=False, dest='debug_plot', action='store_true')
