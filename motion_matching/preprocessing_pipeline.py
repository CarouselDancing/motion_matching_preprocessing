...
from .poselib import compute_velocities_poselib
...
class PreprocessingPipeline:
    def __init__(self, **kwargs):
        ...
        self.velocity_calc_version = kwargs.get("velocity_calc_version", 0)
    ...
    def process_motion(self, positions, rotations, names, parents):
        ...
        if self.velocity_calc_version > 0:
            velocities, angular_velocities = compute_velocities_poselib(positions, rotations, 1)
        else:
            print("use old compute velocities")
            velocities, angular_velocities = self.compute_velocities(positions, rotations)
    ...
    def process_motion_file(self, filename, mirror):
        ...
        print("ground offset",self.grounding_offset)
